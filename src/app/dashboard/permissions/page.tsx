            ...
            {ROLES.map(role => (
              <button
                ...
                style={{
                  ...
                  background: selectedRole === role.value ? `${role.color}15` : 'var(--background)',
                }}
              >
...
const styles: Record<string, React.CSSProperties> = {
  ...
  resetBtn: { display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.625rem 1rem', background: 'var(--secondary)', border: '1px solid #475569', borderRadius: '0.5rem', color: 'var(--foreground)', cursor: 'pointer', fontWeight: '500' },
  content: { background: 'var(--card)', borderRadius: '1rem', border: '1px solid var(--border)', padding: '1.5rem' },
  roleSelector: { marginBottom: '2rem' },
  sectionTitle: { fontSize: '1rem', fontWeight: '600', color: 'var(--foreground)', marginBottom: '1rem' },
  ...
  roleInfo: { flex: 1 },
  roleName: { fontWeight: '600', color: 'var(--foreground)', fontSize: '0.95rem' },
  roleDesc: { fontSize: '0.75rem', color: 'var(--muted-foreground)', marginTop: '0.15rem' },
  permissionsSection: {},
  ...
  permissionsTable: { border: '1px solid var(--border)', borderRadius: '0.75rem', overflow: 'hidden' },
  tableHeader: { display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: '0.5rem', padding: '0.75rem 1rem', background: 'var(--background)', borderBottom: '1px solid #334155' },
  ...
  moduleName: { fontWeight: '600', color: 'var(--foreground)', fontSize: '0.9rem' },
  moduleDesc: { fontSize: '0.75rem', color: 'var(--muted-foreground)' },
  actionCol: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.35rem', color: 'var(--muted-foreground)', fontSize: '0.8rem' },
